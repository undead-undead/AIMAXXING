...
use brain::agent::evolution::auditor::{Auditor, AuditResult, ChangeType};
...
#[async_trait]
impl brain::security::VesselInspector for VesselInspector {
    ...
    async fn inspect_soul(&self, _extract_to: &Path) -> Result<()> {
        Ok(())
    }
}
