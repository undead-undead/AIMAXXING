...
use brain::agent::scheduler::{Scheduler, JobSchedule, JobPayload};
...
impl Tool for CronTool {
    ...
    async fn definition(&self) -> ToolDefinition {
        ToolDefinition {
            ...
            is_binary: false,
            is_verified: true,
            usage_guidelines: Some("Use this to schedule recurring tasks or reminders. Ensure the action description is clear so you understand it when it triggers in the future.".to_string()),
        }
    }
    ...
    async fn call(&self, arguments: &str) -> anyhow::Result<String> {
        ...
        match args.action.as_str() {
            ...
            "list" => {
                ...
                let mut table = brain::infra::format::MarkdownTable::new(vec!["ID", "Name", "Schedule", "Enabled"]);
                for job in jobs {
