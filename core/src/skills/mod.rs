...
pub struct DynamicSkill {
    ...
    env_manager: Option<Arc<crate::env::EnvManager>>,
    runtime: Option<Arc<dyn crate::skills::runtime::SkillRuntime>>,
}
...
impl DynamicSkill {
    ...
    pub fn with_runtime(mut self, runtime: Arc<dyn crate::skills::runtime::SkillRuntime>) -> Self {
    ...
    pub fn with_env_manager(mut self, env_manager: Arc<crate::env::EnvManager>) -> Self {
...
impl Tool for DynamicSkill {
    ...
    async fn call(&self, arguments: &str) -> anyhow::Result<String> {
        use crate::skills::runtime::{QuickJSRuntime, SkillRuntime, MicroPythonRuntime, SmartNodeRuntime};
        ...
        let runtime = if let Some(ref r) = self.runtime {
            ...
            match runtime_type {
                ...
                _ => Arc::new(sandbox::NativeShellRuntime::new()),
            }
        };
...
pub struct SkillLoader {
    ...
    pub(crate) env_manager: Option<Arc<crate::env::EnvManager>>,
    #[cfg(feature = "wasm")]
    pub(crate) wasm_runtime: Arc<crate::skills::runtime::WasmRuntime>,
}
...
impl SkillLoader {
    ...
    pub fn new(base_path: impl Into<PathBuf>) -> Self {
        Self {
            ...
            env_manager: None,
            #[cfg(feature = "wasm")]
            wasm_runtime: Arc::new(crate::skills::runtime::WasmRuntime::new()),
        }
    }
    ...
    pub async fn load_skill(&self, path: &Path) -> Result<DynamicSkill> {
        let (metadata, instructions) = crate::skills::compiler::SkillParser::parse_file(path).await?;
